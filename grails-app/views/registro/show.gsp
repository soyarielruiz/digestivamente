...
<html>
    ...
    <body>
        ...
        <div id="show-registro" class="content scaffold-show" role="main">
            ...
            <f:display bean="registro" />
            <g:form resource="${this.registro}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.registro}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
